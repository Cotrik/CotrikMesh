...
int main(int argc, char* argv[])
{
    if (argc < 2)
    {
        std::cout << "Usage: RemovePadding hex.vtk" << std::endl;
        return -1;
    }
    ...
    baseComplexEditor.RemoveOnePadding();
    baseComplexEditor.WriteBaseComplex_ColorFacesVTK("RemoveOnePadding.face.vtk");
    baseComplexEditor.WriteBaseComplex("RemoveOnePadding.hex.vtk");
    return 0;
}
