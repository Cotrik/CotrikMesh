...
int main(int argc, char* argv[]) {
	...
	//auto singularityShortestPathToCut = GetSingularityShortestPathVidsToCut(mesh, cut_graph_eids);
	//{
	//	std::cout << "Writing singularityShortestPathToCut.vtk\n";
	//	MeshFileWriter writer(mesh, "singularityShortestPathToCut.vtk");
	//	writer.WriteLinksVtk(singularityShortestPathToCut);
	//}
	//auto scut = GetSingularityShortestPathEidsToCut(singularityShortestPathToCut, key_edgeIds);
	//for (auto eid : cut_graph_eids) scut.insert(eid);
	////std::set<size_t> scut(cut_graph_eids.begin(), cut_graph_eids.end());
